...
---
*Generated automatically by Wire Framework v3.10.9 · `/wire:dbt-migration-generate 01-gdp-snowflake-to-bq`*
````
...
### v3.10.9 — Batch-zero macro & UDF pass, single-SCC batching fallback (July 2026)
