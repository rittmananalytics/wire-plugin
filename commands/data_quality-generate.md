...
Generate data quality based on requirements and design specifications.
...
**Output**:
```
## data quality Generated Successfully

**File(s):** [list generated files]

### Next Steps

1. **Validate data quality**: `/wire:data_quality-validate <project>`
2. After validation, review: `/wire:data_quality-review <project>`
```
