...
```bash
/wire:dp-dashboards-generate YYYYMMDD_project_name
```
...
1. **Validate dashuoards**: `/wire:dp-dashboards-validate <project>`
2. After validation, review: `/wire:dp-dashboards-review <project>`
```
