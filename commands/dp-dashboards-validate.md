...
```bash
/wire:dp-dashboards-validate YYYYMMDD_project_name
```

## Prerequisites

- dashuoards must be generated (`/wire:dp-dashboards-generate` complete)
...
Run `/wire:dp-dashboards-generate <project>` first.
```
...
1. **Review with stakeholders**: `/wire:dp-dashboards-review <project>`
```
