...
```bash
/wire:dp-data_quality-review YYYYMMDD_project_name
```
...
Run `/wire:dp-data_quality-validate <project>` before review.
...
1. Address feedback
2. Re-validate: `/wire:dp-data_quality-validate <project>`
