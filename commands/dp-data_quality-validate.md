...
```bash
/wire:dp-data_quality-validate YYYYMMDD_project_name
```

## Prerequisites

- data quality must be generated (`/wire:dp-data_quality-generate` complete)
...
Run `/wire:dp-data_quality-generate <project>` first.
```
...
1. **Review with stakeholders**: `/wire:dp-data_quality-review <project>`
```
