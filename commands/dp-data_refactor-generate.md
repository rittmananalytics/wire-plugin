...
```bash
/wire:dp-data_refactor-generate YYYYMMDD_project_name
```
...
Complete dbt review: /wire:dp-dbt-review <project>
```
...
1. **Validate refactored project**: `/wire:dp-data_refactor-validate <project>`
   Verify the refactored project compiles and runs against real data
2. After validation, review: `/wire:dp-data_refactor-review <project>`
```
