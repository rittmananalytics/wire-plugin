...
```bash
/wire:dp-data_refactor-review YYYYMMDD_project_name
```
...
Run: /wire:dp-data_refactor-validate <project>
```
...
### Next Steps
1. **Data quality checks**: `/wire:dp-data_quality-generate <project>`
2. **User acceptance testing**: `/wire:dp-uat-generate <project>`
```
...
### Next Steps
1. **Regenerate refactor**: `/wire:dp-data_refactor-generate <project>`
2. Then re-validate: `/wire:dp-data_refactor-validate <project>`
3. Then re-review: `/wire:dp-data_refactor-review <project>`
```
