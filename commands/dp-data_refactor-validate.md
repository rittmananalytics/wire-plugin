...
```bash
/wire:dp-data_refactor-validate YYYYMMDD_project_name
```
...
### Next Steps
1. **Review refactored project**: `/wire:dp-data_refactor-review <project>`
```
...
### Recommended Action
Fix the issues identified above and re-run: `/wire:dp-data_refactor-validate <project>`
If schema changes are needed, regenerate: `/wire:dp-data_refactor-generate <project>`
```
