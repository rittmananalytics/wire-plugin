...
1. Run dbt models: `/wire:dp-utils-run-dbt <project_id>`
2. Validate models: `/wire:dp-dbt-validate <project_id>`
3. Review with team: `/wire:dp-dbt-review <project_id>`
```
...
3. **Review with Analytics Engineering**:
   /wire:dp-dbt-review <project_id>

### Quick Links

- View summary: `.wire/<project_id>/dev/dbt_models_summary.md`
- dbt models: `dbt/models/`
- View status: `/wire:dp-status <project_id>`
```
