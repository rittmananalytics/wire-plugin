...
```bash
/wire:dp-deployment-generate YYYYMMDD_project_name
```
...
1. **Validate deployment**: `/wire:dp-deployment-validate <project>`
2. After validation, review: `/wire:dp-deployment-review <project>`
```
