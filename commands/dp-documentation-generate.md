...
```bash
/wire:dp-documentation-generate YYYYMMDD_project_name
```
...
1. **Validate documentation**: `/wire:dp-documentation-validate <project>`
2. After validation, review: `/wire:dp-documentation-review <project>`
```
