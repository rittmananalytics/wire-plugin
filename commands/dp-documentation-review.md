...
```bash
/wire:dp-documentation-review YYYYMMDD_project_name
```
...
Run `/wire:dp-documentation-validate <project>` before review.
...
1. Address feedback
2. Re-validate: `/wire:dp-documentation-validate <project>`
