...
```bash
/wire:dp-documentation-validate YYYYMMDD_project_name
```

## Prerequisites

- documentation must be generated (`/wire:dp-documentation-generate` complete)
...
Run `/wire:dp-documentation-generate <project>` first.
```
...
1. **Review with stakeholders**: `/wire:dp-documentation-review <project>`
```
