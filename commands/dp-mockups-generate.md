...
```bash
/wire:dp-mockups-generate YYYYMMDD_project_name
```
...
- If not, show error and suggest `/wire:dp-requirements-review <project>`
...
2. **Review mockups**: `/wire:dp-mockups-review <project>`
3. After review approval, **generate visualization catalog**: `/wire:dp-viz_catalog-generate <project>`
```
...
1. **Review mockups** with stakeholders: `/wire:dp-mockups-review <project>`
...
Complete requirements approval: /wire:dp-requirements-review <project>
```
