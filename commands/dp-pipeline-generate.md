...
```bash
/wire:dp-pipeline-generate YYYYMMDD_project_name
```
...
1. **Validate pipeline**: `/wire:dp-pipeline-validate <project>`
2. After validation, review: `/wire:dp-pipeline-review <project>`
```
