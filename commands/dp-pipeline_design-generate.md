...
```bash
/wire:dp-pipeline_design-generate YYYYMMDD_project_name
```
...
2. Verify `requirements.review == approved`. If not:
   ...
   Run: /wire:dp-requirements-review <project_id>
   ```
3. Verify `conceptual_model.review == approved`. If not:
   ...
   Run: /wire:dp-conceptual_model-review <project_id>
   ```
...
1. Validate the pipeline design:
   /wire:dp-pipeline_design-validate <project_id>

2. After validation, technical review:
   /wire:dp-pipeline_design-review <project_id>
