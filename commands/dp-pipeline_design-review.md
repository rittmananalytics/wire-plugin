...
```bash
/wire:dp-pipeline_design-review YYYYMMDD_project_name
```
...
Run `/wire:dp-pipeline_design-validate <project>` before review.
...
1. Address feedback
2. Re-validate: `/wire:dp-pipeline_design-validate <project>`
