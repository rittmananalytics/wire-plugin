...
```bash
/wire:dp-requirements-validate YYYYMMDD_project_name
```
...
Run `/wire:dp-requirements-generate [folder]` first to generate requirements.
```
...
1. **Review requirements with stakeholders**: `/wire:dp-requirements-review [folder]`
2. After approval, proceed to design: `/wire:dp-pipeline_design-generate [folder]`
```
