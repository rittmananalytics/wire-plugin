...
```bash
/wire:dp-seed_data-generate YYYYMMDD_project_name
```
...
Complete data model review: /wire:dp-data_model-review <project>
```
...
1. **Validate seed data**: `/wire:dp-seed_data-validate <project>`
   Checks referential integrity, PK uniqueness, type consistency
2. After validation, review: `/wire:dp-seed_data-review <project>`
3. Then generate dbt project: `/wire:dp-dbt-generate <project>`
```
...
Run: /wire:dp-data_model-generate <project>
```
