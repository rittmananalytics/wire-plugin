...
```bash
/wire:dp-semantic_layer-generate YYYYMMDD_project_name
```
...
1. **Validate semantic layer**: `/wire:dp-semantic_layer-validate <project>`
   This will cross-reference all table/column references against the source DDL
2. After validation, review: `/wire:dp-semantic_layer-review <project>`
3. **Sync in Looker IDE** - Pull changes and validate
...
- /wire:dp-requirements-review <project>
- /wire:dp-data_model-review <project>
```
