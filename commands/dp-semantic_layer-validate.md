...
```bash
/wire:dp-semantic_layer-validate YYYYMMDD_project_name
```

## Prerequisites

- Semantic layer must be generated (`/wire:dp-semantic_layer-generate` complete)
...
Run `/wire:dp-semantic_layer-generate <project>` first.
```
...
2. **Review with stakeholders**: `/wire:dp-semantic_layer-review <project>`
