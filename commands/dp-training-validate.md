...
```bash
/wire:dp-training-validate YYYYMMDD_project_name
```

## Prerequisites

- training must be generated (`/wire:dp-training-generate` complete)
...
Run `/wire:dp-training-generate <project>` first.
```
...
1. **Review with stakeholders**: `/wire:dp-training-review <project>`
```
