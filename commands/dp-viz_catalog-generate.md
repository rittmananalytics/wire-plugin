...
```bash
/wire:dp-viz_catalog-generate YYYYMMDD_project_name
```
...
Complete mockups review: /wire:dp-mockups-review <project>
```
...
2. **Generate data model**: `/wire:dp-data_model-generate <project>`
