...
```bash
/wire:dp-workshops-generate YYYYMMDD_project_name
```
...
2. Run `/wire:dp-requirements-validate [folder]`
3. Get final approval: `/wire:dp-requirements-review [folder]`
```
...
3. **After the workshop**:
   ...
   - Re-validate: `/wire:dp-requirements-validate [folder]`
   - Get approval: `/wire:dp-requirements-review [folder]`
```
...
1. Review requirements directly: `/wire:dp-requirements-review [folder]`
...
Generate requirements first: /wire:dp-requirements-generate [folder]
```
