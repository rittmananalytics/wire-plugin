...
```bash
/wire:dp-workshops-review YYYYMMDD_project_name
```

## Prerequisites

- Workshop materials generated (`/wire:dp-workshops-generate` complete)
...
3. **Get final approval**:
   /wire:dp-requirements-review [folder]

4. **Once approved, proceed to design**:
   /wire:dp-pipeline_design-generate [folder]
```
...
Generate workshop materials first: /wire:dp-workshops-generate [folder]
```
