...
```bash
/dp:dashboards:generate YYYYMMDD_project_name
```
...
1. **Validate dashuoards**: `/dp:dashboards:validate <project>`
2. After validation, review: `/dp:dashboards:review <project>`
```
