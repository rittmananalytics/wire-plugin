...
```bash
/dp:data_quality:generate YYYYMMDD_project_name
```
...
1. **Validate data quality**: `/dp:data_quality:validate <project>`
2. After validation, review: `/dp:data_quality:review <project>`
```
