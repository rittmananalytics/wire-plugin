...
```bash
/dp:deployment:generate YYYYMMDD_project_name
```
...
1. **Validate deployment**: `/dp:deployment:validate <project>`
2. After validation, review: `/dp:deployment:review <project>`
```
