...
```bash
/dp:documentation:generate YYYYMMDD_project_name
```
...
1. **Validate documentation**: `/dp:documentation:validate <project>`
2. After validation, review: `/dp:documentation:review <project>`
```
