...
```bash
/dp:workshops:generate YYYYMMDD_project_name
```
...
2. Run `/dp:requirements:validate [folder]`
3. Get final approval: `/dp:requirements:review [folder]`
```
...
3. **After the workshop**:
   ...
   - Re-validate: `/dp:requirements:validate [folder]`
   - Get approval: `/dp:requirements:review [folder]`
```
...
1. Review requirements directly: `/dp:requirements:review [folder]`
