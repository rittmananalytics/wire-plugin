...
```bash
/dp:workshops:review YYYYMMDD_project_name
```

## Prerequisites

- Workshop materials generated (`/dp:workshops:generate` complete)
...
3. **Get final approval**:
   /dp:requirements:review [folder]

4. **Once approved, proceed to design**:
   /dp:pipeline_design:generate [folder]
```
...
Generate workshop materials first: /dp:workshops:generate [folder]
```
