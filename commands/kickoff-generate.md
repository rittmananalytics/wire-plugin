...
After copying, rewrite these four references in the output HTML:

| Original | Rewritten |
|----------|-----------|
| `href="colors_and_type.css"` | `href="kickoff/colors_and_type.css"` |
| `href="deck.css"` | `href="kickoff/deck.css"` |
| `src="mermaid.min.js"` | `src="kickoff/mermaid.min.js"` |
| `src="deck-stage.js"` | `src="kickoff/deck-stage.js"` |
