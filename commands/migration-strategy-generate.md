...
- Platform pair files:
  ...
  - Snowflake → BigQuery: `wire/platform_pairs/snowflake_to_bigquery/translation_guide.md`

## Workflow

### Step 1: Load platform pair context

Read the translation guide and type mapping for the active platform pair. These files define the default translation decisions for all SQL constructs, data types, and configuration patterns.
