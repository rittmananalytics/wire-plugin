...
```bash
/wire:mockups-review YYYYMMDD_project_name
```
...
Run `/wire:mockups-validate <project>` before review.
...
1. Address feedback
2. Re-validate: `/wire:mockups-validate <project>`
