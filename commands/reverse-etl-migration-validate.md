...
Checks the reverse ETL migration runbook for completeness — every in-scope sync has migration steps, SQL translations are present for rewrite_model syncs, rebuild plans cover all Customer Studio audiences and Journeys, and Lightning schema provisioning is documented. Produces a PASS/FAIL report.
...
**Check 1 — All in-scope syncs covered**
...
**Check 2 — rewrite_model syncs have SQL diffs**
...
**Check 3 — Translated SQL verified on target**
...
**Check 4 — Rebuild plans documented**
...
**Check 5 — Lightning schema provisioning documented**
...
**Check 6 — Rollback procedures present**
The runbook includes a rollback procedure for at least each approach type (repoint / rewrite_model / rebuild).
PASS: Rollbacks present for all approach types used. FAIL: List missing rollbacks.

**Check 7 — Source deactivation deferred to cutover**
The runbook does not instruct deactivating source syncs during the migration phase — only during cutover.
PASS: Source deactivation is in the cutover section only. FAIL: Source deactivation appears in migration steps.
