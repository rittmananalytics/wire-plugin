...
```bash
/wire:training-review YYYYMMDD_project_name
```
...
Run `/wire:training-validate <project>` before review.
...
1. Address feedback
2. Re-validate: `/wire:training-validate <project>`
