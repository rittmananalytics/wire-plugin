---
description: Record UAT feedback
...
---
description: Record stakeholder review feedback on uat
argument-hint: <project-folder>
---
...
Record stakeholder feedback on the uat. Captures approval or change requests.

## Usage

```bash
/wire:uat-review YYYYMMDD_project_name
```
...
Please review the uat and provide feedback.
```
...
1. Follow the meeting context retrieval workflow defined in `specs/utils/meeting_context.md`
   - Pass the project folder and artifact name `uat`
...
```json
{
  "questions": [{
    ...
    "options": [
      {"label": "Approved", "description": "uat is complete and approved"},
      {"label": "Changes requested", "description": "uat needs revisions"},
...
**Ask for reviewer**:
```
Who approved the uat? (Name and role)
```
