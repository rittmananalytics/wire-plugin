...
| [Kickoff Deck](./kickoff-deck) | `kickoff_deck` | Pennant Advisory Partners — 10-week data platform onboarding | Delivery-lead agent reading SOW and meeting transcripts; structured slide deck outline within 48 hours of signature; no technical deliverables |
...
| [Agentic Commerce](./agentic-commerce) | `agentic_commerce` | Thornwick Outdoor Ltd — AI features on an existing Shopify store | Lovable storefront scaffolding; GitHub bidirectional sync; Supabase pgvector; semantic search, conversational assistant, and visual similarity in parallel; UCP server packaging |
