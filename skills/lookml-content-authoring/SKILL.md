...
- Looker API or MCP server
- Live database connections
- Query execution or testing
...
Always examine existing project files first, follow established conventions, validate against source schema, and provide comprehensive summaries of changes made.
